...
const FIELDS = [
  ...
  },
  {
    ...
    unit: '%',
    hint: 'Насколько сверх полной себестоимости (закупка + упаковка + доля постоянных расходов, с поправкой на списания) вы хотите зарабатывать. 25 значит цена на 25% выше себестоимости. Переопределяется маржой подкатегории (раздел «Подкатегории») и индивидуальной маржой товара (карточка товара).',
  },
];
