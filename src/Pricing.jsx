...
const FIELDS = [
  ...
  },
  {
    ...
    unit: '%',
    hint: 'Насколько сверх полной себестоимости (закупка + упаковка + доля постоянных расходов, с поправкой на списания) вы хотите зарабатывать. 25 значит цена на 25% выше себестоимости. Если у категории товара задана своя целевая маржа (раздел «Категории»), для её товаров используется она.',
  },
];
