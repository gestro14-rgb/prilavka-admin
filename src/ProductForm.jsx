...
const EMPTY_PRODUCT = {
  ...
  cardTitle: '',
  cardSubtitle: '',
  // Цветная плашка-тег секции «Сегодня на прилавке» на Главной
...
// Пресеты цвета для плашки-тега блока «Сегодня на прилавке» (migrations/052).
    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div className="card" style={{ padding: 24 }}>
          ...
          <div className="section-label">Тег для блока «Сегодня на прилавке» (опционально)</div>
          <div className="form-grid">
            <div className="field">
            ...
            <div className="field full">
              <div className="hint">
                Заполненный текст тега сам заводит товар в блок «Сегодня на прилавке» на Главной — отдельно включать ничего не нужно.
                Порядок и точный состав блока можно задать вручную во вкладке «Сегодня на прилавке» раздела «Главная страница»; пока подборка
                там пуста, в блок попадают все товары с заполненным тегом. Сам тег на витрине не печатается — он только отбирает товары.
                Пишите то, что правда про сам продукт («Сладкая!», «Хрустящие», «Мягкие»), — это не статус вроде «Хит», для него есть
                «Метка на карточке» ниже.
              </div>
            </div>
          </div>
